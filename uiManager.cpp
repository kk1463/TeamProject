...
HRESULT uiManager::init()
{
	...
	IMAGEMANAGER->addImage("갑옷", "갑옷.bmp", 40, 31, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("반지", "반지.bmp", 30, 30, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("지팡이", "지팡이.bmp", 25, 43, true, RGB(255, 0, 255));
